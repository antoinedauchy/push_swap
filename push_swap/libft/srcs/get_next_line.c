...
/*   Updated: 2018/02/26 18:53:20 by adauchy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../libft.h"

static int		get_line(int *stack, char **line, int end)
{
	int			size;
	int			n;
...
static int		update_stack(int **stack, int size_read)
{
	int			*new_stack;
	int			n;
...
static int		write_in_stack(char buffer[BUFF_SIZE], int **stack, int fd)
{
	int			size_read;
	int			n;
	int			nl;
...
static int		get_stack(int ***tab_stack, int fd)
{
	int			size;
	int			**new_tab;
	int			n;
